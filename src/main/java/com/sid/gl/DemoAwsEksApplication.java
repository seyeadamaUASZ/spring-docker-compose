...
import com.sid.gl.book.Book;
import com.sid.gl.book.BookRepository;
...
public class DemoAwsEksApplication {

	public static void main(String[] args) {
		SpringApplication.run(DemoAwsEksApplication.class, args);
	}
